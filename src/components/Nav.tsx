      ...
      <div className="bg-[#e63329] px-6 py-5">
        <div className="max-w-5xl mx-auto flex items-baseline justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Link href="/ai" className="text-xs font-mono uppercase tracking-widest text-white/80 hover:text-white transition-colors">
              AI + Job Security
            </Link>
            <Link href="/lgbt" className="text-xs font-mono uppercase tracking-widest text-white/80 hover:text-white transition-colors">
              #NoHatefulConduct
            </Link>
